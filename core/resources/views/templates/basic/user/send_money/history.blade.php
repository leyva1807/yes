                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="p-1 d-flex flex-column">
                                <small class="text-muted"><i class="las la-exchange-alt"></i> @lang('Conversion Rate')</small>
                                <h6>1 {{ __($general->cur_text) }} = <span class="base_currency_rate"></span></h6>
                            </div>
                            <div class="p-1 d-flex flex-column">
                                <small class="text-muted"><i class="las la-money-bill"></i> @lang('Sent Amount Including Charge In') {{ __($general->cur_text) }}</small>
