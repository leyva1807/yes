                                ...
                                <div class="col-sm-6 col-xl-6 ">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control form--control checkUser" name="username" required
                                ...
                                <div class="col-sm-6 col-xl-6 ">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control checkUser form--control" name="email" required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input--group">
                                            ...
                                            <div class="form--select-light">
                                                <select aria-label="Default select example" class="form-select form--select"
                                                    name="country">
