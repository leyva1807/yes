                    ...
                    <div class="card custom--card">
                        ...
                        <div class="card-body">
                            ...
                            <form role="form" id="payment-form" method="{{ $data->method }}" action="{{ $data->url }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="d-block sm-text mb-2">@lang('Name on Card')</label>
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <label class="d-block sm-text mb-2">@lang('Expiration Date')</label>
                                        <input type="tel" class="form-control form--control" name="cardExpiry" value="{{ old('cardExpiry') }}" autocomplete="off" required />
                                    </div>
                                    <div class="col-md-6 ">
                                        <label class="d-block sm-text mb-2">@lang('CVC Code')</label>
