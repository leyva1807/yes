            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <form action="{{ route('user.deposit.insert') }}" method="post">
                        ...
                        <input name="amount" type="hidden" value="{{ $sendMoney->base_currency_amount + $sendMoney->base_currency_charge }}">
                                ...
                                <div class="mt-3 preview-details d-nonee">
                                    <ul class="list-group list-group-flush text-center">
                                        <li class="list-group-item px-0 d-flex justify-content-between">
                                            ...
                                            <span>{{ showAmount($sendMoney->sending_amount + $sendMoney->sending_charge) }}
                                                {{ $sendMoney->sending_currency }}</span>
                                        </li>
                                        <li class="list-group-item px-0 d-flex justify-content-between">
                                            <span>@lang('In') {{ __($general->cur_text) }}</span>
                                            <span>{{ showAmount($sendMoney->base_currency_amount + $sendMoney->base_currency_charge) }}
