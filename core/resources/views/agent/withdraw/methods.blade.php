        ...
        <div class="col-xxl-5 col-xl-7 col-md-8 col-sm-10">
            <div class="border--card">
                <div class="d-flex justify-content-between">
                    ...
                    <span class="fw-bold">@lang('Available Balance'): {{ showAmount(authAgent()->balance) }} {{ __($general->cur_text) }}</span>
                </div>
                <div class="card-body p-0">
                    <form action="{{ route('agent.withdraw.money') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label class="d-block sm-text mb-2">@lang('Method')</label>
                        ...
                        <div class="mb-3">
                            <label class="d-block sm-text mb-2">@lang('Amount')</label>
                            <div class="input-group">
                                <input type="text" name="amount" value="{{ old('amount') }}" class="form--control form--control" required>
    ...
    <script>
        (function($) {
            ...
            $('select[name=method_code]').change(function() {
                ...
                var final_amo = parseFloat(parseFloat(receivable) * rate).toFixed(2);
