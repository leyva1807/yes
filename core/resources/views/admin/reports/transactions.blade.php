                                    ...
                                    <tr>
                                        <td>
                                            @if ($trx->user_id)
                                                ...
                                                <br>
                                                <span class="small">
                                                    <a href="{{ appendQuery('search', @$trx->user->username) }}"><span>@</span>{{ @$trx->user->username }}</a>
                                                </span>
                                            @else
                                                <span class="fw-bold">{{ @$trx->agent->fullname }}</span>
                                                <br>
                                                <span class="small">
                                                    <a href="{{ appendQuery('search', @$trx->agent->username) }}"><span>@</span>{{ @$trx->agent->username }}</a>
                                                </span>
                                            @endif
                                        </td>
