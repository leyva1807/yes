                        ...
                        <table class="table--light style--two table">
                            ...
                            <tbody>
                                @forelse ($sourceOfFunds as $sourceOfFund)
                                    <tr>
                                        <td>
                                            {{ $sourceOfFunds->firstItem() + $loop->index }}
                                        </td>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge--{{ $sourceOfFund->status == Status::DISABLE ? 'danger' : 'success' }}">{{ $sourceOfFund->status == Status::DISABLE ? 'Disabled' : 'Active' }}</span>
                                        </td>
