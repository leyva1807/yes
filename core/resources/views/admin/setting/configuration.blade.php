                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable') <span class="fw-bold">@lang('KYC (Know Your Client)')</span> @lang('module, users must have to submit the required data. Otherwise, configured') <a href="{{ route('admin.kyc.setting.module') }}" target="_blank">@lang('modules')</a> @lang('will be prevented by this system. You\'ve to configure the') <span class="fw-bold"><i>@lang('KYC Setting')</i></span>.</small>
                                    </p>
                                </div>
                                <div class="form-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, user\'s can reffer others.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="referral_system" @if ($general->referral_system) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Agent System')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, Agent panel will activated and agent can transfer and withdraw money.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="agent_module" @if ($general->agent_module) checked @endif>
                                </div>
                            </li>
