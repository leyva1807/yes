                            ...
                            <tbody>
                                @forelse ($sendingPurposes as $sendingPurpose)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-pill badge--{{ $sendingPurpose->status == Status::DISABLE ? 'danger' : 'success' }}">{{ $sendingPurpose->status == Status::ENABLE ? 'Disabled' : 'Active' }}</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm btn-outline--primary cuModalBtn ml-1" data-modal_title="@lang('Update Sending Purpose')" data data-resource="{{ $sendingPurpose }}" data-has_status="1"><i class="las la-pen"></i>@lang('Edit')</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
