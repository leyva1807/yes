        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget bg="19" color="white" icon="las la-money-bill-wave-alt"
                        link="{{ route('admin.report.transaction') }}?search={{ $user->username }}" style="3"
                        title="Refunded Balance" value="{{ $general->cur_sym }}{{ showAmount($user->balance) }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget bg="primary" color="white" icon="las la-wallet"
                        link="{{ route('admin.send.money.all') }}?search={{ $user->username }}" style="3"
                        title="Sent Money" value="{{ $general->cur_sym }}{{ showAmount($totalSendMoney) }}" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget bg="1" color="white" icon="fas fa-wallet"
                        link="{{ route('admin.deposit.list') }}?search={{ $user->username }}" style="3"
                        title="Payments" value="{{ $general->cur_sym }}{{ showAmount($totalDeposit) }}" />
                </div>
                <!-- dashboard-w1 end -->
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" min="0" name="per_send_money_limit"
                                            ...
                                            value="{{ getAmount($user->per_send_money_limit) }}">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" min="0" name="daily_send_money_limit"
                                            step="any" type="number"
                                            value="{{ getAmount($user->daily_send_money_limit) }}">
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" min="0" name="monthly_send_money_limit"
                                            step="any" type="number"
                                            value="{{ getAmount($user->monthly_send_money_limit) }}">
                                        <span class="input-group-text">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                            </div>
